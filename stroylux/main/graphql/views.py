...
unhandled_errors_logger = logging.getLogger("main.graphql.errorsAddressCreate.unhandled")
handled_errors_logger = logging.getLogger("main.graphql.errorsAddressCreate.handled")
...
class GraphQLView(View):
    ...
    def _handle_query(self, request: HttpRequest) -> JsonResponse:
        try:
            ...
            return JsonResponse(
                data={"errorsAddressCreate": [self.format_error("Unable to parse query.")]},
                status=400,
            )
