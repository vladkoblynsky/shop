...
class Payment(models.Model):
    ...
    checkout = models.ForeignKey(
        Checkout, null=True, blank=True, related_name="payments", on_delete=models.SET_NULL
    )
    ...
    payment_method = models.ForeignKey(
        'PaymentMethod', related_name="+", null=True, on_delete=models.SET_NULL
    )
...
class PaymentMethod(models.Model):
    ...
    base_url = models.URLField(max_length=100, blank=True, null=True)
    credentials_schema = JSONField(blank=True, default=dict)
    is_active = models.BooleanField(default=True)
