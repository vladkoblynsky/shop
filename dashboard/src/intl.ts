...
export const commonMessages = defineMessages({
	...
	deleteCategories: {
		...
		defaultMessage:
			'{counter,plural,one{Are you sure you want to delete this category?} other{Are you sure you want to delete {displayQuantity} categories?}}'
	},
	deleteProducts: {
		id: 'delete_products',
		defaultMessage:
	...
	deleteExportsTitle: {
		id: 'deleteExportsTitle',
		defaultMessage: 'Delete exports',
		description: 'delete exports title'
	},
	deleteExports: {
		id: 'deleteExports',
		defaultMessage:
			'{counter,plural,one{Are you sure you want to delete this product?} other{Are you sure you want to delete {displayQuantity} exports?}}',
		description: 'delete exports text'
	}
})
export const formMessages = defineMessages({
	...
	incorrectPasswordUsername: {
		...
		defaultMessage:
			'Sorry, your email and/or password are incorrect. Please try again.'
	},
	passwordsNotMatch: {
...
export const buttonMessages = defineMessages({
	...
	exportProducts: {
		...
		description: 'export products button'
	},
	importProducts: {
		id: 'importProducts',
		defaultMessage: 'Import',
		description: 'import products button'
	},
	exportImportProducts: {
		id: 'exportImportProducts',
		defaultMessage: 'Export / Import',
		description: 'export/import products button'
	}
})
