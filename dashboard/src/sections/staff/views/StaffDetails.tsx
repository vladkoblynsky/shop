                          ...
                          return (
                            <>
                              ...
                              <ActionDialog
                                ...
                                title={intl.formatMessage({id: "delete_staff_user",
                              ...
                              >
                                <DialogContentText>
                                  <FormattedMessage id="sure_delete_from_staff_members{email}"
                              ...
                              <ActionDialog
                                ...
                                title={intl.formatMessage({id: "delete_staff_user_avatar",
                              ...
                              >
                                <DialogContentText>
                                  <FormattedMessage id="sure_remove_avatar{email}"
