...
import { getUserInitials, maybe } from "@temp/misc";
...
const StaffProperties: React.FC<StaffPropertiesProps> = props => {
  ...
  return (
    <Card className={className}>
      <CardTitle
        title={intl.formatMessage({id: "staff_member_information",
            ...
            <div className={classes.avatar}>
              {maybe(() => staffMember.avatar.url) ? (
                ...
                <div className={classes.avatarDefault}>
                  <Typography>{getUserInitials(data as StaffMemberDetails_user)}</Typography>
                </div>
              )}
              {canEditAvatar && (
