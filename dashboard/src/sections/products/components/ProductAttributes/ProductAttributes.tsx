...
} from '@temp/components/MultiAutocompleteSelectField'
...
import { ProductDetails_product_attributes_attribute_values } from '@temp/sections/products/types/ProductDetails'
			...
			<CardContent className={classes.cardContent}>
				<div className={classes.expansionBar}>
					<div className={classes.expansionBarLabelContainer}>
						<Typography
							className={classes.expansionBarLabel}
							variant='caption'
							component='div'
						>
							<FormattedMessage
								id='number_product_attributes'
