                                ...
                                >
                                    ...
                                    >
                                        <TableCell className={classes.colPrice}>
                                            {maybe(() => product.priceRange.start) &&
                                            maybe(() => product.priceRange.start.amount) !== undefined &&
                                            maybe(() => product.priceRange.start.currency) !== undefined ? (
                                                <>
                                                    <Money money={product.priceRange.start} />
                                                    {product.priceRange.start.amount !== product.priceRange.stop.amount &&
                                                    <> - <Money money={product.priceRange.stop}/></>
                                                    }
                                                </>
                                            ) : (
                                                <Skeleton />
