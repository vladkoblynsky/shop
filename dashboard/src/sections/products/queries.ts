...
} from '@temp/sections/products/types/ProductList'
import {
	ProductDetails,
...
} from '@temp/sections/products/types/ProductImageById'
import {
...
} from '@temp/sections/products/types/GridAttributes'
import {
	ExportObjList,
	ExportObjListVariables
} from '@temp/sections/products/types/ExportObjList'
...
export const exportObjFragment = gql`
	fragment ExportObjFragment on ExportObjType {
		id
		created
		fileName
		fileUrl
...
const initialProductFilterDataQuery = gql`
	query InitialProductFilterData($categories: [ID!], $productTypes: [ID!]) {
...
export const exportObjList = gql`
	${exportObjFragment}
	${pageInfoFragment}
	query ExportObjList(
		$first: Int
		$filter: ExportObjFilterInput
		$sortBy: ExportObjOrder
		$after: String
		$before: String
	) {
		exportObjList(
...
`
export const TypedProductExportListQuery = TypedQuery<
	ExportObjList,
	ExportObjListVariables
>(exportObjList)
