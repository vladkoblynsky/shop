...
import useElementScroll from "@temp/hooks/useElementScroll";
import useSearchQuery from "@temp/hooks/useSearchQuery";
import { buttonMessages } from "@temp/intl";
import { getUserInitials, getUserName } from "@temp/misc";
import { SearchStaffMembers_search_edges_node } from "@temp/searches/types/SearchStaffMembers";
import { DialogProps, FetchMoreProps, SearchPageProps } from "@temp/types";
...
const AssignMembersDialog: React.FC<AssignMembersDialogProps> = ({
  ...
  return (
    <Dialog onClose={onClose} open={open} maxWidth="sm" fullWidth>
      <DialogTitle>
        <FormattedMessage id="assign_staff_members"
      ...
      <DialogContent className={classes.inputContainer}>
        <TextField
          ...
          label={intl.formatMessage({id: "search_staff_members",
            defaultMessage: "Search Staff Members"
          })}
          placeholder={intl.formatMessage({id: "search_by_name,email",
      ...
      >
        ...
        >
          <FormattedMessage id="assign" defaultMessage="Assign" description="button" />
        </ConfirmButton>
      </DialogActions>
    </Dialog>
  );
