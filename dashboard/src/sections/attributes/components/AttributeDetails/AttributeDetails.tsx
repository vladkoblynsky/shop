    ...
    <Card>
      ...
      <CardContent>
        <TextField
          ...
          label={intl.formatMessage({ id: 'default_label',
        ...
        <TextField
          ...
          label={intl.formatMessage({ id: 'attribute_code',
          ...
          helperText={
            ...
            intl.formatMessage({id: 'used_internally',
              defaultMessage:
        ...
        <SingleSelectField
          ...
          label={intl.formatMessage({id: 'catalog_input_type',
        ...
        <ControlledCheckbox
          ...
          label={intl.formatMessage({id: 'value_required',
