  ...
  return (
    <Card>
      ...
      <CardContent>
        ...
        <Typography variant="subtitle1">
          <FormattedMessage id="storefront_properties"
        ...
        <ControlledCheckbox
          ...
          label={intl.formatMessage({id: 'used_faceted_navigation',
        ...
        {data.filterableInStorefront && (
          <TextField
            ...
            label={intl.formatMessage({id: 'position_faceted_navigation',
        ...
        <ControlledCheckbox
          ...
          label={intl.formatMessage({id: 'visible_in_storefront',
        ...
        <CardSpacer />
        <Typography variant="subtitle1">
          <FormattedMessage id="dashboard_properties"
        ...
        <ControlledCheckbox
          ...
          label={
            <>
              <FormattedMessage id="use_in_filtering"
                defaultMessage="Use in Filtering"
                description="use attribute in filtering"
              />
              <Typography variant="caption">
                <FormattedMessage id="able_use_attribute_to_filter"
