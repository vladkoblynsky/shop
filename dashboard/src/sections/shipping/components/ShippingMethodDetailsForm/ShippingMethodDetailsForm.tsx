...
const ShippingMethodDetailsForm: React.FC<ShippingMethodDetailsFormProps> = (
	props
) => {
	const {
		defaultCurrency,
				...
				<TextField
					...
					helperText={
						...
						intl.formatMessage({
							...
							defaultMessage: 'This will be shown to customers at checkout',
						})
					}
							...
							<>
								...
								<div className={classes.grid}>
									<TextField
										...
										helperText={
											data.type === ShippingMethodTypeEnum.PRICE
												? getErrorMessage(formErrors.minimumOrderPrice, intl)
												: getErrorMessage(formErrors.minimumOrderWeight, intl)
										}
										label={
											data.type === ShippingMethodTypeEnum.PRICE
												? intl.formatMessage({
									...
									<TextField
										...
										helperText={
											data.type === ShippingMethodTypeEnum.PRICE
												? getErrorMessage(formErrors.maximumOrderPrice, intl)
												: getErrorMessage(formErrors.maximumOrderWeight, intl)
										}
										label={
											data.type === ShippingMethodTypeEnum.PRICE
												? intl.formatMessage({
