...
import { getUserName, maybe, renderCollection } from "@temp/misc";
  ...
  return (
    <ResponsiveTable>
      ...
      >
        ...
        >
          <FormattedMessage id="customer_name" defaultMessage="Customer Name" />
        </TableCellHeader>
        <TableCellHeader
          direction={
        ...
        >
          <FormattedMessage id="customer_email" defaultMessage="Customer Email" />
        </TableCellHeader>
        <TableCellHeader
          direction={
        ...
        >
          <FormattedMessage id="no_of_orders" defaultMessage="No. of Orders" />
        </TableCellHeader>
      </TableHead>
      <TableFooter>
        <TableRow>
          ...
          () => (
            <TableRow>
              <TableCell colSpan={numberOfColumns}>
                <FormattedMessage id="no_customers_found" defaultMessage="No customers found" />
              </TableCell>
            </TableRow>
          )
        )}
