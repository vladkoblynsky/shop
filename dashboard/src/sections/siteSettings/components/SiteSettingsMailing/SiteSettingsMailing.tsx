...
const SiteSettingsMailing: React.FC<SiteSettingsMailingProps> = props => {
  ...
  return (
    <Card>
      <CardTitle
        title={intl.formatMessage({id: "mailing_configuration",
      ...
      <CardContent>
        ...
        <Typography className={classes.cardHelperTextCaption} variant="body2">
          <FormattedMessage id="siteSettingsMailingText"
                            defaultMessage="Configurate your email address from which all automatic emails will be sent to your customers." />
        </Typography>
        <TextField
          disabled={disabled}
          ...
          label={intl.formatMessage({id: "mailing_email_address",
        ...
        <TextField
          ...
          label={intl.formatMessage({id: "mailing_email_sender",
            defaultMessage: "Mailing email sender"
          })}
          helperText={
            getShopErrorMessage(formErrors.defaultMailSenderName, intl) ||
            intl.formatMessage({id: "will_be_visible_from_name",
        ...
        <TextField
          ...
          label={intl.formatMessage({id: "customer_password_reset_url",
            defaultMessage: "Customer password reset URL"
          })}
          placeholder={intl.formatMessage({id: "url_address",
            defaultMessage: "URL address"
          })}
          helperText={
            getShopErrorMessage(formErrors.customerSetPasswordUrl, intl) ||
            intl.formatMessage({id: "customer_set_password_helper_text",
              defaultMessage:
