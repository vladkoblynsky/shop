...
import createMultiFileUploadHandler from "@temp/utils/handlers/multiFileUploadHandler";
import classNames from "classnames";
import React from "react";
import { useIntl } from "react-intl";
import { SortableContainer, SortableElement } from "react-sortable-hoc";

import { ShopImageFragment } from "../../types/ShopImageFragment";
...
interface ImageListContainerProps {
  className: string;
  items: ShopImageFragment[];
  preview: ShopImageFragment[];
  onImageDelete: (id: string) => () => void;
  onImageEdit: (id: string) => () => void;
}
...
const ShopImages: React.FC<ShopImagesProps> = props => {
  const {
    images,
    placeholderImage,
    loading,
          ...
          <CardContent>
            <div className={classes.root}>
              <div className={classes.imageContainer}>
                <img className={classes.image} src={placeholderImage} alt={'shop image'}/>
              </div>
            </div>
          </CardContent>
        ) : images.length > 0 ? (
...
ShopImages.displayName = "ShopImages";
