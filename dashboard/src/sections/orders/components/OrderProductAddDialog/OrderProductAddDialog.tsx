    ...
    >
      ...
      <DialogContent className={classes.overflow}>
        <TextField
          ...
          label={intl.formatMessage({id: "search_products",
            defaultMessage: "Search Products"
          })}
          placeholder={intl.formatMessage({id: "search_by_product_name_attribute_type",
            defaultMessage:
            ...
            <TableBody>
              {renderCollection(
                ...
                () => (
                  <TableRow>
                    <TableCell colSpan={4}>
                      <FormattedMessage id="no_products_matching_given_query"
