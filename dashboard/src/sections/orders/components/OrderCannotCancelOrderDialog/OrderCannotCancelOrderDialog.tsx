...
const OrderCannotCancelOrderDialog: React.FC<DialogProps> = ({
  ...
  return (
    <Dialog onClose={onClose} open={open} maxWidth="sm">
      <DialogTitle>
        <FormattedMessage id="couldnt_cancel_order"
          defaultMessage="Shop couldn’t cancel order"
          description="dialog header"
        />
      </DialogTitle>
      <DialogContent>
        <DialogContentText>
          <FormattedMessage id="cancel_fulfillment_first_before_cancel_order_text"
