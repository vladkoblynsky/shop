import darkLogoSmall from 'images/logo.svg'
...
import useTheme from '@temp/hooks/useTheme'
import useUser from '@temp/hooks/useUser'
import ArrowDropdown from '@temp/icons/ArrowDropdown'
// import { staffMemberDetailsUrl } from "@temp/staff/urls";
				...
				<div className={classes.root}>
					<div className={classes.sideBar}>
						...
						>
							...
							>
								<a href={STOREFRONT_URL} target='_blank'>
									<SVG
										src={isMenuSmall ? darkLogoSmall : darkLogo}
										title='Стройлюкс'
									/>
								</a>
							</div>
															...
															<Paper>
																...
																>
																	<Menu>
																		...
																		>
																			<FormattedMessage
																				{...buttonMessages.accountSettings}
																			/>
																		</MenuItem>
																		<MenuItem
																			className={classes.userMenuItem}
