...
import useDebounce from '@temp/hooks/useDebounce'
...
const UPLOAD_URL = IS_DEV
	? 'http://localhost:8000/ckeditor/upload/'
	: '/ckeditor/upload/'
const BROWSE_URL = IS_DEV
	? 'http://localhost:8000/ckeditor/browse/'
	: '/ckeditor/browse/'
...
const RichCKEditor: React.FC<RichCKEditorProps> = ({
	...
	const onChangeContent = useDebounce<any>((event, editor) => {
