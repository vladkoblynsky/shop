    ...
    <Card>
      ...
      {permissionsExceeded && (
        <>
          <CardContent>
            <Typography>
              {intl.formatMessage({id: "groups_permissions_exceeds_your_own",
                defaultMessage:
          ...
          <CardContent>
            <Typography>
              {intl.formatMessage({id: "available_permissions",
                  ...
                  permissions.map(perm => (
                    ...
                    >
                      ...
                      <ListItemText
                        ...
                        secondary={
                          perm.lastSource &&
                          intl.formatMessage({id: "group_is_last_source_of_that_permission",
                            defaultMessage:
