...
export interface Order_orderByToken_user_defaultShippingAddress_country {
...
export interface Order_orderByToken_user_defaultShippingAddress {
  __typename: "Address";
  /**
   * The ID of the object.
   */
   ...
   */
  country: Order_orderByToken_user_defaultShippingAddress_country;
  countryArea: string;
  phone: string;
}

export interface Order_orderByToken_user_addresses_country {
  __typename: "CountryDisplay";
  /**
   * Country code.
   */
...
export interface Order_orderByToken_user_addresses {
  __typename: "Address";
  /**
   * The ID of the object.
   */
   ...
   * Shop's default country.
   */
  country: Order_orderByToken_user_addresses_country;
  countryArea: string;
  phone: string;
}

export interface Order_orderByToken_user {
  __typename: "User";
  /**
   * The ID of the object.
   */
  ...
  isStaff: boolean;
  isActive: boolean;
  defaultShippingAddress: Order_orderByToken_user_defaultShippingAddress | null;
  /**
   * List of all user's addresses.
   */
  addresses: (Order_orderByToken_user_addresses | null)[] | null;
}
...
export interface Order_orderByToken {
  ...
  user: Order_orderByToken_user | null;
