    ...
    return(
        <form onSubmit={form.handleSubmit} className="flex flex-col">
            ...
            <TextField name="oldPassword"
                       margin="dense"
                       helperText={(form.dirty && form.touched.oldPassword && form.errors.oldPassword)}
                       error={!!(form.touched.oldPassword && form.errors.oldPassword  && form.dirty)}
            ...
            <TextField name="newPassword"
                       margin="dense"
                       helperText={(form.dirty && form.touched.newPassword && form.errors.newPassword)}
                       error={!!(form.touched.newPassword && form.errors.newPassword && form.dirty)}
                       onChange={form.handleChange}
                       ...
                       InputProps={{
                           endAdornment:
                               <InputAdornment position="end">
                                   <IconButton
                                       aria-label="toggle password visibility"
                                       onClick={e => {setShowPassword2(prev => !prev)}}
                                   >
