...
const ShippingAddressForm:React.FC<ShippingAddressFormProps> = ({initialAddressData, email, submitAddress}) =>{

    const form = useFormik({
        initialValues: {...initialValues, ...initialAddressData, country: CountryCode.BY, email},
