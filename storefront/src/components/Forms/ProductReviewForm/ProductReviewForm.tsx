...
import { IS_REQUIRED_TEXT } from '@temp/constants'
			...
			<Grid container spacing={1}>
				<Grid item xs={12}>
					<div className='mb-10'>
						...
						/>
						{form.errors.rating && (
							<FormHelperText error={true}>{form.errors.rating}</FormHelperText>
						)}
					</div>
				</Grid>
				<Grid item xs={12}>
				...
				<Grid item xs={12}>
					<TextField
						...
						helperText={
							form.dirty && form.touched.content && form.errors.content
						}
						onChange={form.handleChange}
						onBlur={form.handleBlur}
						label='Комментарий'
